...
--Changes are recommended to be made in the script-opts directory.
	...
	-----Script Settings----
	auto_run_list_idle = 'titleonly', --Auto run the list when opening mpv and there is no video / file loaded. 'none' for disabled. Or choose between: 'all', 'recents', 'distinct', 'protocols', 'fileonly', 'titleonly', 'timeonly', 'keywords'.

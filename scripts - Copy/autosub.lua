...
local subliminal = 'C:\\Users\\Therese\\AppData\\Local\\Programs\\Python\\Python311\\Scripts\\subliminal.exe'
local temp_dir = 'C:\\Users\\Therese\\AppData\\Roaming\\mpv\\subs'
--=============================================================================
-->>    SUBTITLE LANGUAGE:
--=============================================================================
...
local logins = {
          { '--addic7ed', 'bingewatcher', 'oddsbodikins' },
          { '--opensubtitles', 'bingewatcher7', 'bDw@f68y' },
...
function control_downloads()
    ...
    mp.commandv('rescan_external_files')
    directory, filename = utils.split_path(mp.get_property('media-title'))
...
mp.add_key_binding('alt+m', 'download_subs', download_subs)
mp.add_key_binding(nil, 'download_subs2', download_subs2)

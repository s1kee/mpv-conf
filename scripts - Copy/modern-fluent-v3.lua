...
layouts = function ()
    ...
    geo = {x = 357, y = refY - 27, an = 1, w = osc_geo.w - 50, h = 40}
    lo = add_layout("title")
    lo.geometry = {x = 527, y = refY - 27.5, an = 1, w = 300, h = 40}
...
--    lo.style = osc_styles.mediumButtons
    ...
    lo.geometry = {x = 347, y = refY - 49, an = 7, w = 120, h = 20}
    lo.style = osc_styles.timecodes

    -- Cache
    lo = add_layout("cache")
    lo.geometry = {x = osc_geo.w - 217, y = refY - 50, an = 9, w = 64, h = 20}
    lo.style = osc_styles.timecodes

    -- Volume
    lo = add_layout("volume")
    lo.geometry = {x = 220, y = refY - 40, an = 5, w = 24, h = 24}
    lo.style = osc_styles.smallButtons
	
    lo = new_element('volumebarbg', 'box')
    lo.visible = (osc_param.playresx >= 750) and user_opts.volumecontrol
    lo = add_layout('volumebarbg')
    lo.geometry = {x = 250, y = refY - 40, an = 4, w = 80, h = 4}
    lo.layer = 13
	lo.box.radius = 2
    ...
    lo.geometry = {x = 249, y = refY - 40, an = 4, w = 6, h = 4}
    lo.layer = 13
	lo.box.radius = 2
    lo.style = osc_styles.VolumebarFg
    
	lo = add_layout('volumebar')
    lo.geometry = {x = 250, y = refY - 40, an = 4, w = 80, h = 5}
    lo.style = osc_styles.VolumebarFg
    lo.slider.gap = 0
	lo.slider.border = 0
    lo.slider.tooltip_style = osc_styles.Tooltip

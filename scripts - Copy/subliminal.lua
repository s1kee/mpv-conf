...
local user_opts = {
	...
	-- Provider Log-ins
	addic7ed_username      = 'bingewatcher',
	addic7ed_password      = 'oddsbodikins',
	legendastv_username    = '',
	legendastv_password    = '',
	opensubtitles_username = 'jelaixx',
	opensubtitles_password = 'gZ5c@8TzuiyZLEP',
}
...
local function create_command()
	...
	-- Output
	add_args(args, mp.get_property('media-title', ''))
	return args
end

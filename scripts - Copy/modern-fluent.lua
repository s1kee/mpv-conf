...
local user_opts = {
    ...
    seekbarhandlesize = 0,    -- size ratio of the diamond and knob handle
    seekrangealpha = 230,       -- transparency of seekranges
...
local osc_styles = {
    ...
    vidTitle = "{\\blur0\\bord0\\1c&HFFFFFF&\\3c&H0\\fs32\\q2\\fn" .. user_opts.titlefont .. "}",
...
layouts = function ()
    ...
    lo.geometry = {x = refX, y = refY - 100 , an = 5, w = osc_geo.w - 50, h = 7}
    lo.layer = 13
    ...
    lo.geometry = {x = refX + 3, y = refY - 100 , an = 5, w = osc_geo.w - 50, h = 20}
    lo.style = osc_styles.seekbarFg
    lo.slider.gap = 7
    lo.slider.tooltip_style = osc_styles.tooltip
    lo.slider.tooltip_an = 1


    -- Title y = refY - 132, h = 48
    geo = {x = 25, y = refY - 120, an = 1, w = osc_geo.w - 50, h = 48}
    lo = add_layout("title")
    lo.geometry = {x = 25, y = refY - 120, an = 1, w = osc_geo.w - 50, h = 48}

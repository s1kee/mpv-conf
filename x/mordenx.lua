...
local user_opts = {
    ...
    scalefullscreen = 0.60,      -- scaling of the controller when fullscreen
...
local osc_styles = {
    ...
    SeekbarFg = '{\\blur1\\bord1\\1c&H474747&}',
    ...
    Tooltip = '{\\blur1\\bord0.5\\1c&cfc9c8&\\3c&H000000&\\fs18\\fn' .. user_opts.font .. '}',
    Title = '{\\blur0\\bord0\\1c&Hdad1d0&\\3c&Hdad1d0&\\fs38\\q2\\fn' .. user_opts.font .. '}',
    WinCtrl = '{\\blur1\\bord0.5\\1c&Hcfc9c8&\\3c&H0\\fs20\\fnmpv-osd-symbols}',
...
layouts = function ()
    ...
    geo = { x = 25, y = refY - 125, an = 1, w = osc_geo.w - 50, h = 48 }
    lo = add_layout('title')
    lo.geometry = geo

...
settings['default-style'] = [[\fnSource Sans Pro\b1\shad0\fs20\c&HFdad1d0&\3c&H2D2D2D&]]
...
settings['hover-time-style'] = [[\fs20]]
...
settings['pause-indicator'] = false
...
settings['enable-chapter-markers'] = false
...
settings['animation-duration'] = 0.1
